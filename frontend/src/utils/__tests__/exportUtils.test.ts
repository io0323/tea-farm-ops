...
describe('exportUtils', () => {
  ...
  describe('exportFieldsToCSV', () => {
    it('フィールドデータをCSVエクスポートする', () => {
      ...
      expect(mockCreateObjectURL).toHaveBeenCalled();
      expect(mockLink.setAttribute).toHaveBeenCalledWith('download', expect.stringContaining('fields_'));
    });
  });
  ...
  describe('exportTasksToCSV', () => {
    it('タスクデータをCSVエクスポートする', () => {
      ...
      expect(mockCreateObjectURL).toHaveBeenCalled();
      expect(mockLink.setAttribute).toHaveBeenCalledWith('download', expect.stringContaining('tasks_'));
    });
  });
}); 